  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 text-muted">Find your next mission. {campaigns.length} live campaigns.</p>
      </div>
      ...
      <div className="sticky top-16 z-30 -mx-4 border-b border-border bg-bg/85 px-4 py-3 backdrop-blur-xl sm:-mx-6 sm:px-6">
        <div className="flex h-12 items-center gap-3 rounded-2xl border border-border bg-surface px-4 focus-within:border-gold/50">
          ...
          <input
            ...
            placeholder="Search campaigns, creators, projects…"
      ...
      {list.length ? (
        ...
        <div className="mt-20 text-center">
          <p className="font-display text-xl font-semibold">No campaigns found</p>
